#!/usr/bin/env python
"""
Wrapper script to generate scitbx flex_fwd.h header.
...
# Get the boost_python directory path for scitbx
script_dir = os.path.dirname(os.path.abspath(__file__))
scitbx_dir = os.path.dirname(script_dir)
array_family_dir = os.path.join(scitbx_dir, "array_family")
boost_python_dir = os.path.join(array_family_dir, "boost_python")

if not os.path.isdir(boost_python_dir):
    print("ERROR: boost_python directory not found at:", boost_python_dir)
    sys.exit(1)

print("Generating scitbx/array_family/boost_python/flex_fwd.h...")
