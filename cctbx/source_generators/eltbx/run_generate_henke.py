#!/usr/bin/env python
"""
Wrapper script to generate cctbx henke source files.
...
spec = importlib.util.spec_from_file_location(
    "generate_henke_cpp",
    os.path.join(os.path.dirname(__file__), "generate_henke_cpp.py")
)
generate_henke_cpp = importlib.util.module_from_spec(spec)
spec.loader.exec_module(generate_henke_cpp)
...
print("Generating cctbx henke source files...")
generate_henke_cpp.run(eltbx_dir)
print("Henke generation complete!")
